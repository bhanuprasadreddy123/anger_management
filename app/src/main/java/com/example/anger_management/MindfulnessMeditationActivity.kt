...
class MindfulnessMeditationActivity : AppCompatActivity() {

    private var toneGenerator: ToneGenerator? = null
    private var isPlaying = false
    private var countDownTimer: CountDownTimer? = null
    private var timeLeftInMillis: Long = 10 * 60 * 1000 // 10 minutes in milliseconds
    ...
    private fun startMeditation() {
        ...
        countDownTimer = object : CountDownTimer(timeLeftInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                updateTimerDisplay()
                stopMeditation()
                Toast.makeText(this@MindfulnessMeditationActivity, "Mindfulness meditation completed!", Toast.LENGTH_LONG).show()
            }
        }.start()

        Toast.makeText(this, "Starting Mindfulness Meditation...", Toast.LENGTH_SHORT).show()
    }
