...
class StressReliefMeditationActivity : AppCompatActivity() {

    private var toneGenerator: ToneGenerator? = null
    private var isPlaying = false
    private var countDownTimer: CountDownTimer? = null
    private var timeLeftInMillis: Long = 15 * 60 * 1000 // 15 minutes in milliseconds
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_stress_relief_meditation)
    ...
    private fun startMeditation() {
        if (timeLeftInMillis <= 0) {
            timeLeftInMillis = 15 * 60 * 1000 // Reset to 15 minutes
        }
        ...
        countDownTimer = object : CountDownTimer(timeLeftInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                updateTimerDisplay()
                stopMeditation()
                Toast.makeText(this@StressReliefMeditationActivity, "Stress Relief meditation completed!", Toast.LENGTH_LONG).show()
            }
        }.start()

        Toast.makeText(this, "Starting Stress Relief Meditation...", Toast.LENGTH_SHORT).show()
    }
