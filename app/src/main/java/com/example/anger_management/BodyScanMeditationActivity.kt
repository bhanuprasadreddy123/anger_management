...
class BodyScanMeditationActivity : AppCompatActivity() {

    private var toneGenerator: ToneGenerator? = null
    private var isPlaying = false
    private var countDownTimer: CountDownTimer? = null
    private var timeLeftInMillis: Long = 18 * 60 * 1000 // 18 minutes in milliseconds
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_body_scan_meditation)
    ...
    private fun startMeditation() {
        if (timeLeftInMillis <= 0) {
            timeLeftInMillis = 18 * 60 * 1000 // Reset to 18 minutes
        }
        ...
        countDownTimer = object : CountDownTimer(timeLeftInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                updateTimerDisplay()
                stopMeditation()
                Toast.makeText(this@BodyScanMeditationActivity, "Body Scan meditation completed!", Toast.LENGTH_LONG).show()
            }
        }.start()

        Toast.makeText(this, "Starting Body Scan Meditation...", Toast.LENGTH_SHORT).show()
    }
