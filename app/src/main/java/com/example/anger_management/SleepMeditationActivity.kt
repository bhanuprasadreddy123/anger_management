...
class SleepMeditationActivity : AppCompatActivity() {

    private var toneGenerator: ToneGenerator? = null
    private var isPlaying = false
    private var countDownTimer: CountDownTimer? = null
    private var timeLeftInMillis: Long = 20 * 60 * 1000 // 20 minutes in milliseconds
    ...
    private fun startMeditation() {
        if (timeLeftInMillis <= 0) {
            timeLeftInMillis = 20 * 60 * 1000 // Reset to 20 minutes
        }
        ...
        countDownTimer = object : CountDownTimer(timeLeftInMillis, 1000) {
            ...
            override fun onFinish() {
                ...
                updateTimerDisplay()
                stopMeditation()
                Toast.makeText(this@SleepMeditationActivity, "Sleep meditation completed! Sweet dreams!", Toast.LENGTH_LONG).show()
            }
        }.start()

        Toast.makeText(this, "Starting Sleep Meditation...", Toast.LENGTH_SHORT).show()
    }
